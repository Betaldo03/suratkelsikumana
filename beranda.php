					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Sebelum Anda membuat Surat Keterangan silahkan lengkapi biodata anda, Klik biodata anda</h5>
							</div>
					...
					<div class="row mt--2">
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-warning">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Pindah</h6>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
...
<?php
 ...
 ?>
				...
				<div class="page-inner">
					<!-- Card -->
					<h3 class="fw-bold text-uppercase">JUMLAH SURAT KETERANGAN SUDAH ACC</h3>
...
<?php
 ...
 ?>
				...
				<div class="page-inner">
					<!-- Card -->
					<h4 class="page-title">TAMPIL SURAT KETERANGAN</h4>
					<!-- Card With Icon States Background -->
					<div class="row">
						<div class="col-sm-6 col-md-3">
								<div class="card card-stats card-round">
