...
<body>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/logo.png" style="width: 60px;height: 60px; alt="logo">
              </div>
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="form-group">
												<small for="email">Masukan Alamat Email Anda</small>
                        <input type="text" name="email" class="form-control form-control-lg" placeholder="Email Anda.." required>
											</div>
                <div class="form-group">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/surat/">BATAL</a>
                </div>
  ...
  <?php
    if(isset($_POST['register'])){
        ...
        $sql_simpan = "INSERT INTO data_user (nik,password,hak_akses,nama,tanggal_lahir,jekel,tempat_lahir,email) VALUES ('$nik','$password','$hak_akses','$nama','$tgl','$jekel','$kota','$email')";
        $query_simpan =($konek,$sql_simpan);
