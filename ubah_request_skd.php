						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">UBAH SURAT KETERANGAN DOMISILI</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['ubah'])){
	...
	$sql = "UPDATE data_request_skd SET scan_ktp='$file_ktp',scan_kk='$file_kk',keperluan='$keperluan' WHERE id_request_skd=$id";
