					...
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">STATUS SURAT KETERANGAN TIDAK MAMPU</h4>
									</div>
								</div>
								<div class="card-body">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<?php endif?>
															<?php if($sts == 3):?>
															<a href="?halaman=view_sktm&id_request_sktm=<?= $id_request_sktm;?>">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">STATUS SURAT KETERANGAN PINDAH</h4>
									</div>
								</div>
								<div class="card-body">
									<div class="table-responsive">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<?php if($sts == 3):?>
														<a href="?halaman=view_skp&id_request_skp=<?= $id_request_skp;?>">
															<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat">
																<i class="fa fa-edit"></i>
															</button>
														</a>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">STATUS SURAT KETERANGAN DOMISILI</h4>
									</div>
								</div>
								<div class="card-body">
									<div class="table-responsive">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<?php endif?>
														<?php if($sts == 3):?>
														<a href="?halaman=view_skd&id_request_skd=<?= $id_request_skd;?>">
															<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat">
																<i class="fa fa-edit"></i>
															</button>
														</a>
